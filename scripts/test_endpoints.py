...
def test_v1_dashboard(token):
    ...
    # Dashboard summary
    r = test_endpoint("GET /api/v1/dashboard/summary", "GET", f"{BASE_URL}/api/v1/dashboard/summary", headers=headers)
    if r:
        try:
            data = r.json()["data"]
...
def test_v1_analytics(token):
    ...
    # Traffic analysis
    r = test_endpoint("GET /api/v1/analytics/traffic", "GET", f"{BASE_URL}/api/v1/analytics/traffic", headers=headers)
    if r:
        try:
            data = r.json()["data"]
...
def test_v1_alerts(token):
    ...
    # List alerts
    r = test_endpoint("GET /api/v1/alerts", "GET", f"{BASE_URL}/api/v1/alerts", headers=headers)
    alert_id = None
    if r:
        try:
            data = r.json()
    ...
    test_endpoint(
        "GET /api/v1/alerts?page=1&limit=5", "GET", f"{BASE_URL}/api/v1/alerts?page=1&limit=5", headers=headers
    )

    # Get single alert (if we have one)
    if alert_id:
        r = test_endpoint(
            f"GET /api/v1/alerts/{alert_id}", "GET", f"{BASE_URL}/api/v1/alerts/{alert_id}", headers=headers
        )
        if r:
            try:
                data = r.json()["data"]
    ...
    test_endpoint(
        "GET /api/v1/alerts/99999 (expect 404)", "GET", f"{BASE_URL}/api/v1/alerts/99999", 404, headers=headers
    )
...
def test_v1_assets(token):
    ...
    # List assets
    r = test_endpoint("GET /api/v1/assets", "GET", f"{BASE_URL}/api/v1/assets", headers=headers)
    device_id = None
    if r:
        try:
            data = r.json()
    ...
    test_endpoint("GET /api/v1/assets?search=device", "GET", f"{BASE_URL}/api/v1/assets?search=device", headers=headers)

    # Asset summary
    r = test_endpoint("GET /api/v1/assets/summary", "GET", f"{BASE_URL}/api/v1/assets/summary", headers=headers)
    if r:
        try:
            data = r.json()["data"]
    ...
    if device_id:
        test_endpoint(
            f"GET /api/v1/assets/{device_id}", "GET", f"{BASE_URL}/api/v1/assets/{device_id}", headers=headers
        )
...
def test_unauthorized_access():
    ...
    for endpoint in endpoints:
        test_endpoint(f"GET {endpoint} (expect 401)", "GET", f"{BASE_URL}{endpoint}", 401)
