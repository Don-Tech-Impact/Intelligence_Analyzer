...
class SIEMAnalyzer:
    ...
    def start(self):
        ...
        self.consumer_thread = Thread(target=self._run_consumer, name="RedisConsumer", daemon=True)
        self.consumer_thread.start()

        # Start API server in separate thread
        self.api_thread = Thread(target=self._run_api, name="APIServer", daemon=True)
