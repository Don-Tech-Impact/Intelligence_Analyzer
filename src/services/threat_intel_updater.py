...
class ThreatIntelUpdater:
    ...
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": "SIEM-Analyzer/1.0"})
    ...
    def _parse_feed_data(self, data: str, feed_type: str, feed_name: str) -> List[Dict[str, Any]]:
    ...
    def _store_indicators(self, indicators: List[Dict[str, Any]], source: str) -> int:
        """Store indicators in database.
            ...
            with db_manager.session_scope() as session:
                for indicator_data in indicators:
                    ...
                    existing = (
                        ...
                        .filter(ThreatIntelligence.indicator_value == indicator_value)
                        .first()
                    )
