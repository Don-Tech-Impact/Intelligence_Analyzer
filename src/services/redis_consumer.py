...
class RedisConsumer:
    ...
    def _handle_dead_log(self, log_data: Dict[str, Any]) -> bool:
        ...
        """
        tenant_id = log_data.get("tenant_id") or log_data.get("metadata", {}).get("tenant_id", "unknown")
    ...
    def process_message(self, queue_name: str, message: str) -> bool:
        ...
        try:
            ...
            if queue_name == "log_queue":
                ...
                tenant_id = log_data.get("tenant_id") or log_data.get("metadata", {}).get("tenant_id") or "default"
