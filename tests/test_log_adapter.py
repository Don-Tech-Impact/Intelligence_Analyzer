...
class TestLogAdapterV2Schema:
    ...
    def test_v2_nested_extraction(self):
        ...
        log = {
            ...
            "vendor": "paloalto",
            "device": {"hostname": "PA-500", "vendor": "paloalto", "model": "PA-500", "role": "firewall"},
            "event": {
            ...
            "source": {"ip": "192.168.1.100", "port": 54321, "mac": "00:11:22:33:44:55", "user": "admin"},
            "destination": {"ip": "10.0.0.1", "port": 22, "service": "ssh"},
            "network": {"protocol": "tcp", "bytes": 1500, "direction": "inbound"},
            "business_context": {"is_business_hour": True, "day_of_week": "Monday"},
            "raw": {"message": "SSH login failed for user admin"},
        }
...
class TestLogAdapterLegacyFormats:
    ...
    def test_parsed_metadata_wrapper(self):
        ...
        log = {
            "parsed": {"src_ip": "192.168.1.1", "dst_ip": "8.8.8.8", "src_port": 12345, "dst_port": 53, "proto": "udp"},
            "metadata": {"tenant_id": "parsed-tenant", "severity": "medium"},
...
class TestLogAdapterEdgeCases:
    ...
    def test_tenant_id_strip_brackets(self):
        ...
        log = {"schema_version": "v2.0", "tenant_id": "[test-tenant]", "source": {"ip": "10.0.0.1"}}
    ...
    def test_invalid_port(self):
        ...
        log = {"schema_version": "v2.0", "tenant_id": "test", "source": {"ip": "10.0.0.1", "port": "not-a-number"}}
...
class TestLogAdapterBruteForceCompatibility:
    ...
    def test_auth_failure_log_has_required_fields(self):
        ...
        log = {
            ...
            "source": {"ip": "203.0.113.50", "port": 52341, "user": "admin"},
            "destination": {"ip": "192.168.1.10", "port": 22},
            "raw": {"message": "Failed password for admin from 203.0.113.50"},
        }
...
class TestLogAdapterPortScanCompatibility:
    ...
    def test_network_log_has_required_fields(self):
        ...
        log = {
            ...
            "vendor": "cisco",
            "event": {"timestamp": "2026-02-08T14:30:00Z", "category": "network", "action": "drop"},
            "source": {"ip": "10.10.10.100", "port": 44444},
            "destination": {"ip": "192.168.1.50", "port": 22},  # Each scan hits different port
            "network": {"protocol": "tcp"},
        }
...
class TestLogAdapterBeaconingCompatibility:
    ...
    def test_outbound_log_has_required_fields(self):
        ...
        log = {
            ...
            "vendor": "paloalto",
            "event": {"timestamp": "2026-02-08T14:30:00Z", "category": "network", "action": "allow"},
            "source": {"ip": "192.168.1.200"},
            "destination": {"ip": "45.33.32.156", "port": 443},
...
class TestLogAdapterRealRepo1Format:
    ...
    def test_real_fortinet_log_from_repo1(self):
        ...
        log = {
            ...
            "vendor": "fortinet",
            "metadata": {
                "raw_log": 'date=2024-10-24 time=08:15:23 devname="FG100E" \
                    logid="0000000013" type="traffic" subtype="allowed" \
                    srcip=192.168.1.100 srcport=44321 dstip=8.8.8.8 dstport=443 \
                    proto=6 action="allow"',
                "received_at": None,
            ...
            "source": {"ip": "192.168.1.100", "port": 44321, "hostname": None, "mac": None},
            "destination": {"ip": "8.8.8.8", "port": 443, "hostname": None, "service": "https"},
            "network": {"protocol": "tcp", "direction": "outbound"},
            "device": {"hostname": "FG100E", "vendor": "fortinet", "type": "firewall"},
            "hmac_signature": "1bcbc1eb5bdca745241f51aa677832047e555915d6e69fd860ec1d29f5b11283",
            "hmac_algorithm": "HMAC-SHA256",
            "source_info": {"authenticated": True, "source_ip": "127.0.0.1", "api_key": "xg5AabiMBoc15GRmaeOrRA"},
        }
    ...
    def test_real_ubiquiti_log_from_repo1(self):
        ...
        log = {
            ...
            "metadata": {
                "raw_log": (
                    "Feb 8 17:00:01 EdgeRouter-X kernel: [WAN_LOCAL-default-D]IN=eth0 OUT= "
                    "MAC=00:11:22:33:44:55 SRC=203.0.113.50 DST=192.168.1.1 LEN=60 TOS=0x00 "
                    "PREC=0x00 TTL=64 ID=12345 PROTO=TCP SPT=52341 DPT=22"
                ),
            ...
            "source": {"ip": "203.0.113.50", "port": 52341},
            "destination": {"ip": "192.168.1.1", "port": 22, "service": "ssh"},
            "network": {"protocol": "tcp", "direction": "inbound"},
            "device": {"hostname": "EdgeRouter-X", "vendor": "ubiquiti_edge"},
            "threat_intel": {"indicators": ["remote_access_attempt"], "risk_score": 7},
        }
    ...
    def test_real_pfsense_log_from_repo1(self):
        ...
        log = {
            ...
            "vendor": "pfsense",
            "metadata": {
                "raw_log": "<134>Aug 23 14:32:00 pfSense filterlog: \
                    1,16777216,,1000000103,em0,match,pass,in,4,0x0,,64,0,0,0,6,\
                    tcp,60,192.168.1.100,192.168.1.1,44321,80,0,S,12345,,mss",
            ...
            "source": {"ip": "192.168.1.100", "port": 44321},
            "destination": {"ip": "192.168.1.1", "port": 80, "service": "http"},
            "network": {"protocol": "tcp", "direction": "inbound", "interface": "em0"},
            "device": {"hostname": "pfSense", "vendor": "pfsense", "type": "firewall"},
        }
...
class TestLogAdapterV1Schema:
    ...
    def test_v1_schema_detected(self):
        ...
        log = {
            ...
            "level": "info",
            "metadata": {"device_type": "cisco_asa", "source_ip": "192.168.1.100"},
        }
        result = LogAdapter.normalize(log)
    ...
    def test_v1_raw_log_preserved_as_message(self):
        ...
        log = {"schema_version": "v1", "tenant_id": "EBK", "raw_log": raw, "metadata": {"device_type": "cisco_asa"}}
        result = LogAdapter.normalize(log)
    ...
    def test_v1_regex_extraction_ufw(self):
        ...
        raw = (
            "Mar 17 00:00:00 fw kernel: [UFW BLOCK] IN=eth0 OUT= "
            "SRC=192.168.1.50 DST=8.8.8.8 SPT=12345 DPT=443 PROTO=TCP"
        )
        log = {
            "schema_version": "v1",
            "tenant_id": "TEST",
    ...
    def test_v1_regex_extraction_generic(self):
        ...
        log = {"schema_version": "v1", "tenant_id": "TEST", "raw_log": raw, "metadata": {"device_type": "generic"}}
        result = LogAdapter.normalize(log)
        assert result.source_ip == "1.2.3.4"
